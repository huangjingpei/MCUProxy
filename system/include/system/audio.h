...
typedef enum {
    ...
    AUDIO_STREAM_DTMF             = 8,
    AUDIO_STREAM_TTS              = 9,
    /* grandstream code start, 2013-05-24 */
    AUDIO_STREAM_VOICE_CALL_SPEAKER     = 10,
    AUDIO_STREAM_VOICE_CALL_HANDSET     = 11,
    AUDIO_STREAM_VOICE_CALL_HEADSET     = 12,
    AUDIO_STREAM_VOICE_CALL_BLUETOOTH   = 13,
    /* grandstream code end */
    AUDIO_STREAM_CNT,
...
enum {
    ...
    /* grandstream code start, 2013-05-24 */
    AUDIO_DEVICE_OUT_HANDSET                   = 0x10000,
    /* grandstream code end */
    ...
    /* grandstream code start, 2013-05-24 */
    AUDIO_DEVICE_IN_HANDSET               = AUDIO_DEVICE_BIT_IN | 0x2000000,
    AUDIO_DEVICE_IN_BLUETOOTH_SCO         = AUDIO_DEVICE_BIT_IN | 0x4000000,
    /* grandstream code end */
    ...
    AUDIO_DEVICE_IN_ALL     = (AUDIO_DEVICE_IN_COMMUNICATION |
                               ...
                               AUDIO_DEVICE_IN_AF |
                               /* grandstream code start, 2013-05-24 */
                               AUDIO_DEVICE_IN_HANDSET |       
                               AUDIO_DEVICE_IN_BLUETOOTH_SCO |
                               /* grandstream code end */
